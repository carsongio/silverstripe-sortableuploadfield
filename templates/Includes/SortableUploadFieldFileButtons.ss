...
<% end_if %>
<button data-href="$UploadFieldSortLink" class="ss-uploadfield-item-sort ss-ui-button ui-corner-all" data-icon="minus-circle"><% _t('UploadField.Sort', 'Sort from files') %></button>